      ...
      <div className="space-y-5">
        ...
        <Field label="Bio">
          <textarea
            ...
            rows={3}
            className="w-full rounded border border-subtle bg-surface-2 px-2.5 py-1.5 text-xs text-foreground placeholder:text-foreground/25 focus:border-foreground/20 focus:outline-none resize-none"
          />
        </Field>
        ...
        <div className="flex gap-2">
          <Field label="Emoji" className="w-16">
            <input
              ...
              placeholder="🎯"
              maxLength={4}
              className="w-full rounded border border-subtle bg-surface-2 px-2.5 py-1.5 text-xs text-foreground text-center placeholder:text-foreground/25 focus:border-foreground/20 focus:outline-none"
            />
          </Field>
...
function Field({
  ...
  return (
    <div className={className}>
      ...
      {children}
      {hint && <p className="mt-1 text-2xs text-foreground/20">{hint}</p>}
    </div>
  );
}
