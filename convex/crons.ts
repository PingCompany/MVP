...
// crons.interval("generate-decisions-from-alerts", { minutes: 5 }, internal.decisionGenerator.generateFromAlerts);
// crons.interval("generate-decisions-from-summaries", { minutes: 5 }, internal.decisionGenerator.generateFromSummaries);
